...
RUN curl -skL https://github.com/riemann/riemann/releases/download/0.2.14/riemann-0.2.14.tar.bz2 | bunzip2 | tar -x && \
...
CMD [ "bin/riemann", "test", "/app/etc/riemann.config" ]